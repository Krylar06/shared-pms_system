...
<div
    ...
    @php
        $deviceTypeName = strtolower($device->type?->name ?? '');
        $isDesktopType = $deviceTypeName === 'desktop';
        $isComputerType = in_array($deviceTypeName, ['desktop', 'laptop'], true);
        $deviceUrl = route('admin.devices.show', $device);
    @endphp
            ...
            <form method="POST" action="{{ route('admin.devices.update', $device) }}" class="space-y-4" x-on:submit="cleanUnitPrices($event.target)">
                ...
                <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                    <div>
                        ...
                        <select name="device_type_id" x-model="selectedTypeId"
                    ...
                    <div>
                        ...
                        <input name="property_number" value="{{ old('property_number', $device->property_number) }}"
                    ...
                    <div>
                        ...
                        <input name="computer_name" value="{{ old('computer_name', $device->computer_name) }}"
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2" maxlength="100"
                            pattern="[A-Za-z0-9][A-Za-z0-9\-\s]*" title="Letters, numbers, hyphens, and spaces only"
                            placeholder="Enter computer name">
                    </div>

                    <div>
                        <label class="text-sm font-medium">Brand</label>
                        <input name="brand" value="{{ old('brand', $device->brand) }}"
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2" maxlength="100"
                    ...
                    <div>
                        ...
                        <input name="model" value="{{ old('model', $device->model) }}"
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2" maxlength="100"
                    ...
                    <div x-show="isComputerType()" x-cloak>
                        ...
                        <input name="mac_address" value="{{ old('mac_address', $device->mac_address) }}"
                            ...
                            placeholder="00:1A:2B:3C:4D:5E" :disabled="!isComputerType()">
                    </div>
                    ...
                    <div x-show="isComputerType()" x-cloak>
                        ...
                        <input name="specs[memory]" value="{{ old('specs.memory', data_get($device->specs, 'memory')) }}"
                    ...
                    <div x-show="isComputerType()" x-cloak>
                        ...
                        <input name="specs[storage]" value="{{ old('specs.storage', data_get($device->specs, 'storage')) }}"
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2" maxlength="50"
                            :disabled="!isComputerType()">
                    </div>
                    ...
                    <div id="show_os_version_wrapper" style="display:none;">
                        ...
                        <select name="os_version" id="show_os_version_select"
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2">
                            <option value="">-- Select OS --</option>
                            <option value="Windows 7" {{ old('os_version', $device->os_version) === 'Windows 7' ? 'selected' : '' }}>Windows 7</option>
                            <option value="Windows 8" {{ old('os_version', $device->os_version) === 'Windows 8' ? 'selected' : '' }}>Windows 8</option>
                    ...
                    <div id="show_ms_version_wrapper" style="display:none;">
                        ...
                        <select name="ms_office_version" id="show_ms_version_select"
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2">
                            <option value="">-- Select MS Office --</option>
                            <option value="Office 2007" {{ old('ms_office_version', $device->ms_office_version) === 'Office 2007' ? 'selected' : '' }}>Office 2007</option>
                            <option value="Office 2010" {{ old('ms_office_version', $device->ms_office_version) === 'Office 2010' ? 'selected' : '' }}>Office 2010</option>
                ...
                <div>
                    ...
                    <textarea name="maintenance_remarks" rows="3" maxlength="1000"
                        class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2">{{ old('maintenance_remarks', $device->maintenance_remarks) }}</textarea>
                </div>

                <div>
                    <label class="text-sm font-medium">Notes</label>
                    <textarea name="notes" rows="3" maxlength="2000"
                        class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2">{{ old('notes', $device->notes) }}</textarea>
                </div>
